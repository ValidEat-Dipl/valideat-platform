...
export const routes: Routes = [
  { path: 'admin-overview', component: AdminOverviewComp }, // fertig, sortieren nach typ
  { path: 'most-recent-created', component: MostRecentTicketsComp }, // *
  { path: 'create-ticket', component: CreateTicketComp }, // fertig, noch keine datalist bei emps, kein hr erkennung weil fehlendes user system
  ...
  { path: 'ticket-details/correct/:id', component: CorrectTicketComp }, // in bearbeitung
  {
    path: 'employee',
    loadChildren: () =>
